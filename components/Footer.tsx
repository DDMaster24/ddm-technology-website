    ...
    <footer className="border-t border-white/5 bg-[#060612]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 text-sm max-w-sm mb-4">
              AI automation for South African businesses. We build AI employees
              that handle your customers 24/7 so you never miss a lead.
            </p>
          ...
          <div>
            <h4 className="font-semibold text-sm text-white mb-4">Get in Touch</h4>
            <ul className="space-y-2 text-sm text-gray-400">
              <li>
                <a href="mailto:darius@ddmtech.co.za" className="hover:text-cyan-400 transition-colors">
                  darius@ddmtech.co.za
                </a>
              </li>
              <li>Roodepoort, Johannesburg</li>
              <li>South Africa</li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/5 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-gray-500">
            &copy; {new Date().getFullYear()} DDM Technology (Pty) Ltd. All rights reserved.
          </p>
          <div className="flex gap-4">
            ...
            <a href="mailto:darius@ddmtech.co.za" className="text-gray-400 hover:text-cyan-400 transition-colors" aria-label="Email">
