    ...
    downloads: [
      {
        ...
        version: '1.0.5',
        size: '79.2 MB',
        url: 'https://github.com/DDMaster24/ddm-technology-website/releases/download/ddm-ic-v1.0.5/DDM-IC-Setup-1.0.5-Windows.zip',
    ...
    downloads: [
      {
        ...
        version: '1.0.0',
        size: '63.1 MB',
        url: 'https://github.com/DDMaster24/ddm-technology-website/releases/download/v1.0.0/DocumentSummarizer-Windows-Installer.1.zip',
